...
CREATE MULTISET TABLE awp_sdm.Vendor_DIM
(
      Vendor_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Country_Region_DIM
(
...
CREATE MULTISET TABLE awp_sdm.Payment_Type_DIM
(
...
CREATE MULTISET TABLE awp_sdm.Person_DIM
(
      Person_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Product_Cat_DIM
(
...
CREATE MULTISET TABLE awp_sdm.Product_DIM
(
      Product_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Product_Purchase_Fact_Monthly
(
      Vendor_id INTEGER,
      Product_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Product_Sales_Fact_Monthly
(
      Customer_ID INTEGER,
      Order_Month_ID DATE FORMAT 'MM/DD/YYYY',
      Ship_Month_ID DATE FORMAT 'MM/DD/YYYY',
...
CREATE MULTISET TABLE awp_sdm.Product_Sub_Cat_DIM
(
      Product_Sub_Cat_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Purchase_Fact_Monthly
(
      Vendor_id INTEGER,
      Order_Month_id DATE FORMAT 'MM/DD/YYYY',
...
CREATE MULTISET TABLE awp_sdm.Sales_Fact_Monthly
     (
      Customer_ID INTEGER,
      Order_Month_ID DATE FORMAT 'MM/DD/YYYY',
      Ship_Month_ID DATE FORMAT 'MM/DD/YYYY',
...
CREATE MULTISET TABLE awp_sdm.Sales_Type_DIM
(
...
CREATE MULTISET TABLE awp_sdm.Ship_Type_DIM
(
      Ship_Type_id INTEGER,
...
CREATE MULTISET TABLE awp_sdm.Territory_DIM
(
      Territory_id INTEGER,
